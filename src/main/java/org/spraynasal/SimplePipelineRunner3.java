...
import org.spraynasal.core.ex3.ShiftTranslatorLocator;
 ...
 * @author sebastian
 */
public class SimplePipelineRunner3 {
    ...
    public static void main(String[] args) throws IOException, UIMAException {
        ...
        ExternalResourceFactory
                .bindResource(processor, TranslateEngine.TRANSLATOR, ShiftTranslatorLocator.class);
