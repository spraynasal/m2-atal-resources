...
import org.spraynasal.core.ex2.HashTranslatorLocator;
 ...
 * @author sebastian
 */
public class SimplePipelineRunner2 {
    ...
    public static void main(String[] args) throws IOException, UIMAException {
        ...
        ExternalResourceFactory
                .bindResource(processor, TranslateEngine.TRANSLATOR, HashTranslatorLocator.class,
                        HashTranslatorLocator.HASH_FUNCTION, (String) config.get("HashFunction"));
