...
import org.spraynasal.core.ex4.CaesarsTranslatorLocator;
 ...
 * @author sebastian
 */
public class SimplePipelineRunner4 {
    ...
    public static void main(String[] args) throws IOException, UIMAException {
        ...
        ExternalResourceFactory
                .bindResource(processor, TranslateEngine.TRANSLATOR, CaesarsTranslatorLocator.class,
                        CaesarsTranslatorLocator.SHIFT, String.valueOf(config.get("Shift")));
